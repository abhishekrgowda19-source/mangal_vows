...
ACTIVATION_AMOUNT    = 50000   # ₹500
RENEWAL_AMOUNT       = 10000   # ₹100
...
def subscribe():
    ...
    order = client.order.create({
        "amount": ACTIVATION_AMOUNT, "currency": "INR", "payment_capture": 1
    })
...
def renew():
    ...
    order = client.order.create({
        "amount": RENEWAL_AMOUNT, "currency": "INR", "payment_capture": 1
    })
